...
//  ScanflowText
//
//  Created by Mac-OBS-46 on 01/03/23.
//
...
class PrePostProcessor : NSObject {
    // 모델 입력 이미지 크기
    static let inputWidth = 416
    static let inputHeight = 416
    // model output is of size 25200*85  10668
    static let outputRow = 10647 // YOLOv5 모델 input size 640 * 640 기준 output Row 값 25200
    static let outputColumn = 6 // 클래스 수 + 5 (left, top, right, bottom, score) 값
